...
class Challenges(Enum):
    ...
    CLUSTER_1 = ChallengeData(name="cluster1", title="Cluster 1 - Misclassification", teaser="Can you find the misclasification?", difficulty=Difficulty.MEDIUM, tags=["DEFCON-31"], artifacts=["census_full_data.csv"])
    ...
    GUESS_WHOS_BACK = ChallengeData(name="guess_whos_back", title="Guess Who's Back - Data Analysis", teaser="Can you guess who's back?", difficulty=Difficulty.EASY, tags=["DEFCON-31"], artifacts=[])
    HUSH = ChallengeData(name="hush", title="Hush - Audio Generation", teaser="Can you discover the hidden audio passphrase?", difficulty=Difficulty.MEDIUM, tags=["DEFCON-31"], artifacts=[])
    ...
    PIXELATED = ChallengeData(name="pixelated", title="Pixelated - Adversarial OCR", teaser="Can you break some OCR for admin?", difficulty=Difficulty.HARD, tags=["DEFCON-31"], artifacts=[])
